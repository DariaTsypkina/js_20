let json = `[{
    ...
    "imgSRC": "assets/images/iron-man/iron-man.jpg",
    ...
    "imgSRC": "assets/images/spiderman/spiderman1.png",
    ...
    "imgSRC": "assets/images/captain/webstory-captain-america-cover03.jpg",
    ...
    "imgSRC": "assets/images/tor/screen-0.jpg",
    ...
    "imgSRC": "assets/images/hulk/hulk.png",
    ...
    "imgSRC": "assets/images/black-widow/e90c2ca475c17424290fd05479d27f52.jpg",
    ...
    "imgSRC": "assets/images/deadpool/deadpool1.jpg",
        ...
        for (let i = 0; i < heroes.length; i++) {
            ...
            <div class="card__info">
                    ...
                    <div class="hero-grade">
                        <label class="hero-grade__title" for="grade">Моя оценка: ${heroes[i].grade || 'Не задана'}</label><br>
                        <input class="hero-grade__input" name="grade" type="number" min="0" max="5" step="0.5" id="input-${i}" value="" onchange='setGrade(${i})'>
...
function setGrade(index) {
    let val = document.getElementById("input-" + index).value;
    
    heroes[index].grade = +val;
